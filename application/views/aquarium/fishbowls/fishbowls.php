                                          ...
                                          <div class="row">
                                              ...
                                              <div class="col-xl-9 xl-70 box-col-12">
                                                  <div class="card">
                                                      ...
                                                      <div class="card-body">
                                                          <div class="todo">
                                                              <div class="todo-list-wrapper vertical-scroll scroll-demo ps-container ps-theme-default ps-active-y">
                                                                      ...
                                                                      <div class="todo-list-body">
                                                                          <div class="todo-list-footer">
                                                                              <div class="new-task-wrapper mb-4">
                                                                                  ...
                                                                                  <textarea id="new-task" placeholder="Ingresar motivo. . ."></textarea><span class="btn btn-danger cancel-btn" id="close-task-panel">Cerrar</span><span class="disabled btn btn-success ms-3 add-new-task-btn" id="add-task" >Guardar</span>
                                                                              </div>
                                                                          </div>
                                                                          <ul id="todo-list">
                                                                              <li class="task">
                                                                                  <div class="task-container">
                                                                                      ...
                                                                                      <div class="d-flex align-items-center gap-4"><span class="badge badge-light-success">Done</span>
                                                                                          <h5 class="assign-name m-0">08 July</h5>
                                                                                      </div>
                                                                                  </div>
                                                                              </li>
                                                                          </ul>
