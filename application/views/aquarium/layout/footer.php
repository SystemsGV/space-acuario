        ...
        <div class="customizer-body custom-scrollbar">
            ...
            <div class="tab-pane fade" id="c-pills-layouts" role="tabpanel" aria-labelledby="c-pills-layouts-tab">
                <ul class="sidebar-type layout-grid layout-types">
                    <li data-attr="compact-sidebar">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/dubai.jpg" class="img-fluid" alt=""></a>
                            <h6>Dubai</h6>
                        </div>
                    </li>
                    <li data-attr="material-layout">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/los-angle.png" class="img-fluid" alt=""></a>
                            <h6>Los Angeles</h6>
                        </div>
                    </li>
                    <li data-attr="dark-sidebar">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/paris.jpg" class="img-fluid" alt=""></a>
                            <h6>Paris</h6>
                        </div>
                    </li>
                    <li data-attr="compact-wrap">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/tokyo.jpg" class="img-fluid" alt=""></a>
                            <h6>Tokyo</h6>
                        </div>
                    </li>
                    <li data-attr="compact-small">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/moscow.jpg" class="img-fluid" alt=""></a>
                            <h6>Moscow</h6>
                        </div>
                    </li>
                    <li data-attr="enterprice-type">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/singapore.jpg" class="img-fluid" alt=""></a>
                            <h6>Singapore</h6>
                        </div>
                    </li>
                    <li data-attr="box-layout" class="box-layout">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/newyork.png" class="img-fluid" alt=""></a>
                            <h6>New York</h6>
                        </div>
                    </li>
                    ...
                    <li data-attr="material-icon">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/rome.jpg" class="img-fluid" alt=""></a>
                            <h6>Rome</h6>
                        </div>
                    </li>
                    ...
                    <li class="only-body" data-attr="default-body">
                        <div class="layout-img"><a href="javascript:void(0)"><img src="../assets/images/landing/layout-images/landon.png" class="img-fluid" alt=""></a>
                            <h6>London</h6>
                        </div>
                    </li>
                </ul>
